...
public class PushVideoTest {
     ...
     *  
     */
    public PushVideoTest from(String src) throws FrameGrabber.Exception {
        // 采集/抓取器
...
//        }
     ...
     *  
     */
    public PushVideoTest to(String out) throws IOException {
        // 录制/推流器
     ...
     *  
     */
    public PushVideoTest go() throws IOException {
    ...
    public static void main(String[] args) throws IOException{
        ...
        new PushVideoTest().from("rtmp://112.74.62.129:1935/normal/classroom01-camera08").to("rtmp://112.74.62.129:11935/violation-rule?vhost=violation-rule-record/classroom01-camera08").go();
    }
