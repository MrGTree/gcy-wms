 ...
 * @version 2013-12-05
 */
public class UserEval extends DataEntity<UserEval> {
	...
	@ExcelField(title="任务延期次数", align=2, sort=74)
	...
	@ExcelField(title="评价次数", align=2, sort=71)
	...
	@ExcelField(title="工作任务条数", align=2, sort=72)
	...
	@ExcelField(title="生产缺陷数量", align=2, sort=73)
	...
	@ExcelField(title="奖励总数", align=2, sort=75)
	...
	@ExcelField(title="惩罚总数", align=2, sort=76)
	...
	public UserEval(String id){
		super(id);
	}

	public UserEval(String id, String loginName){
		super(id);
		this.loginName = loginName;
	}

	public UserEval(Role role){
		super();
		this.role = role;
	}
	 ...
	 * @return
	 */
	@ExcelField(title="归属组", align=2, sort=26)
