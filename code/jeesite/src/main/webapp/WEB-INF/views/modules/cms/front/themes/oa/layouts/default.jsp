...
<body>
	...
	<div class="container">
		...
		<footer>
			<div class="footer_nav"><%--<a href="${ctx}/guestbook" target="_blank">公共留言</a> | <a href="${ctx}/search" target="_blank">全站搜索</a> | <a href="${ctx}/map-${site.id}${fns:getUrlSuffix()}" target="_blank">站点地图</a> | <a href="mailto:thinkgem@163.com">技术支持</a> | --%><a href="${pageContext.request.contextPath}${fns:getAdminPath()}" target="_blank">i2Finance</a></div>
