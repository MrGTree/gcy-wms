...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="officeContent" src="${ctx}/sys/office/list?id=${fns:getUser().office.parentId}<%--&parentIds=--%>" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
